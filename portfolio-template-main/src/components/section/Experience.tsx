  ...
  const experiences = [
    {
      ...
      company: "KEYDATA Information Technologies Systems",
      location: "Ankara,Turkey",
      period: "August 2024 - September 2024",
      description: [
        "Developed individual projects to strengthen algorithmic thinking and application development skills.",
        "Developed responsive front-end interfaces using HTML, improving the overall structure and user experience of web applications."
      ]
    },
    {
      title: "Intern Engineer",
      company: "Nokia Alcatel,Network & Telecommunications",
      location: "Ankara, Turkey",
      period: "July 2025 - September 2025",
      description: [
      "Gained hands-on exposure to mobile and 5G network infrastructure, including base stations and signal transmission concepts.",
      "Benchmarked 8+ document parsing frameworks by extracting tables and images from PDF; prepared a reproducible comparison report using Python.",
      "Performed UI automation testing with Selenium; created and executed test scenarios aligned with Microsoft Certified Professional (MCP) practices.",
      "Developed a Python-based data processing tool that analyzes CSV files and generates HTML reports with statistical summaries of network devices and components."
      ]
    },
    {
      title: "Intern Engineer",
      ...
      description: [
        "Gained exposure to IT systems and communication-based technologies in a public-sector environment.",
      "Assisted in the maintenance and optimization of digital infrastructure operations, ensuring seamless data organization and system reliability.",
      ]
    }
  ];
