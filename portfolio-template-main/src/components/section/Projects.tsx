  ...
  const projects: Project[] = [
    {
      ...
      technologies: ["Python", "FastAPI", "MediaPipe", "MongoDB","OpenCV","SQLite","Ollama","Tkinter"],
      icon: comingSoon,
      detailsUrl: "/projects/ai-lifestyle-coach-agent",
      githubUrl: "https://github.com/ozdemirem18/AI-Lifestyle-Coach-Agent"
    },
    {
      title: "Photobooth",
      description: "A photo booth application built with Python, FastAPI, Pillow, HTML5, CSS3, and JavaScript, deployed on Render.",
      technologies: ["Python", "FastAPI", "Pillow (PIL)", "HTML5/CSS3", "JavaScript", "Render"],
      icon: comingSoon,
