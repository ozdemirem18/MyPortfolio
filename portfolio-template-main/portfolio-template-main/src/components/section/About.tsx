...
import { profile1, profile2, profile3, stickers as stickerImages } from '../../assets';
          ...
          <div className="flex flex-col md:flex-row justify-between items-start max-w-6xl mx-auto gap-8">
            <div className="text-left w-full md:w-auto">
              <div className="ascii-container justify-start text-3xl md:text-4xl lg:text-5xl">
                <AsciiMorphText text="Hi, I'm İrem" />
              </div>
      ...
      <div className="py-8 md:py-12" style={{
        ...
        <div className="container mx-auto px-4 md:px-6">
          <div className="flex items-center justify-center relative min-h-[400px] md:min-h-[600px]">
            ...
            {/* About Me Text Box */}
            <div className="w-full md:max-w-2xl lg:max-w-4xl relative z-20 px-8 py-10 rounded-3xl shadow-xl backdrop-blur-md"
                 style={{
                   backgroundColor: isDarkMode ? 'rgba(31, 41, 55, 0.85)' : 'rgba(255, 255, 255, 0.9)',
                   border: `2px solid ${isDarkMode ? '#374151' : themeColors.colors.pink[200]}`
                 }}>
              <h2 className="text-3xl md:text-4xl font-bold mb-6 text-center" style={{ color: themeColors.colors.pink[500] }}>
                About Me
              </h2>
              
              <div className="space-y-5 text-lg" style={{ color: isDarkMode ? '#e5e7eb' : '#374151' }}>
                <p className="leading-relaxed">
                  Hi, I'm İrem! I am a <strong>Software Engineer</strong> graduated from Türk Hava Kurumu University. 
                  I have a strong passion for building modern web applications, AI-driven solutions, and clean software architectures.
                </p>
                <p className="leading-relaxed">
                  During my summer internship at <strong>Nokia</strong> within the Center of Innovation team in Ankara, I gained hands-on experience in corporate software development and system environments. 
                </p>
                <p className="leading-relaxed">
                  I love turning complex problems into efficient solutions. Recently, I developed <strong>AI Fitness Trainer</strong>, a comprehensive desktop and web application utilizing Python, MediaPipe, OpenCV, FastAPI, and SQLite.
                </p>
                <p className="leading-relaxed text-center font-medium mt-8" style={{ color: themeColors.colors.pink[500] }}>
